...
public class APITokenMaker extends AbstractTokenMaker {
	...
	public TokenMap getWordsToHighlight() {
		...
		int reservedWord = Token.FUNCTION;
		...
		int function = Token.RESERVED_WORD;
		tokenMap.put("abort",			function);
		tokenMap.put("acquire",			function);
		tokenMap.put("execute",			function);
		tokenMap.put("id",			function);
		...
		int adminmethod = Token.PREPROCESSOR;

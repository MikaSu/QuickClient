...
public class LoginFrame extends javax.swing.JFrame {
	...
	public LoginFrame(String docbase) {
		initComponents();
	}
	...
	public LoginFrame() throws DfException {
		...
		if (docbrokerclient != null) {
			...
			for (int i = 0; i < valcount; i++) {
				...
				String pass = ConfigService.getInstance().getParameter(docbasemap.getDocbaseName(i) + ".password");
				String user = ConfigService.getInstance().getParameter(docbasemap.getDocbaseName(i) + ".username");
				txtPassword.setText(pass);
				txtUserName.setText(user);
			}
			IDfTypedObject servermap = docbasemap.getServerMap(0);
			// //System.out.println(servermap.toString());
			String serverString = "";
			int servercount = servermap.getValueCount("r_server_name");
			for (int j = 0; j < servercount; j++) {
				String serverName = servermap.getRepeatingString("r_server_name", j);
				String serverStatus = servermap.getRepeatingString("r_last_status", j);
				String serverHost = servermap.getRepeatingString("r_host_name", j);
				String serverVersion = servermap.getRepeatingString("r_server_version", j);
	...
	void setpointer(MDIMainFrame aThis) {
	...
	private void initComponents() {
		...
		gl_jPanel1.setHorizontalGroup(gl_jPanel1.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
				gl_jPanel1
						...
						.add(gl_jPanel1.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING).add(lblHost).add(jLabel4).add(jLabel3).add(jLabel2).add(jLabel1))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(gl_jPanel1
								.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(cmbServer, 0, 330, Short.MAX_VALUE)
								.add(cmbDocbase, 0, 330, Short.MAX_VALUE)
								.add(txtUserName, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
								.add(txtPassword, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
								.add(org.jdesktop.layout.GroupLayout.TRAILING,
										gl_jPanel1.createSequentialGroup().add(chkAlternativeBroker).addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, 65, Short.MAX_VALUE).add(cmdLogin).addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(cmdCancel).add(8, 8, 8))
								.add(gl_jPanel1.createSequentialGroup().add(txtHostName, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 162, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(lblPort)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(txtPort, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 39, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
										.add(cmdGetDataButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 91, Short.MAX_VALUE))).addContainerGap()));
		gl_jPanel1.setVerticalGroup(gl_jPanel1.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
				gl_jPanel1
						.createSequentialGroup()
						.addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.add(gl_jPanel1.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(jLabel1).add(cmbDocbase, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(gl_jPanel1.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(jLabel2).add(cmbServer, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(gl_jPanel1.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(jLabel3).add(txtUserName, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						.add(gl_jPanel1.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(jLabel4).add(txtPassword, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
						...
						.add(gl_jPanel1.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(gl_jPanel1.createSequentialGroup().add(18, 18, 18).add(gl_jPanel1.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(cmdLogin).add(cmdCancel)))
								.add(gl_jPanel1.createSequentialGroup().addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(chkAlternativeBroker))).addContainerGap()));
	...
	private void cmbDocbaseItemStateChanged(java.awt.event.ItemEvent evt) {// GEN-FIRST:event_cmbDocbaseItemStateChanged
		if (!loading) {
			int idx = cmbDocbase.getSelectedIndex();
			try {
				Cursor cur = new Cursor(Cursor.WAIT_CURSOR);

				setCursor(cur);
				cmbServer.removeAllItems();
				IDfTypedObject servermap = docbasemap.getServerMap(idx);
				// //System.out.println(servermap.toString());
				String serverString = "";
				int servercount = servermap.getValueCount("r_server_name");
				for (int j = 0; j < servercount; j++) {
	...
	private void cmdGetDataButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_cmdGetDataButtonActionPerformed
		docbasecombomodel = new DefaultComboBoxModel();
		servercombomodel = new DefaultComboBoxModel();
		cmbDocbase.setModel(docbasecombomodel);
		cmbServer.setModel(servercombomodel);
	...
	private void chkAlternativeBrokerActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_chkAlternativeBrokerActionPerformed
	...
	private void doLogin() {
		String docbase = (String) cmbDocbase.getSelectedItem();
		String username = txtUserName.getText();
		char[] input = txtPassword.getPassword();
		String passu = new String(input);
	...
	private void cmbDocbaseActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_cmbDocbaseActionPerformed
	...
	private void cmbDocbaseMouseWheelMoved(java.awt.event.MouseWheelEvent evt) {// GEN-FIRST:event_cmbDocbaseMouseWheelMoved

		int maxindex = cmbDocbase.getItemCount();
		if (evt.getWheelRotation() > 0) {
			int index = cmbDocbase.getSelectedIndex();
			if (index < maxindex - 1) {
	 ...
	 */
	public static IDfSessionManager createSessionManager(String docbase, String user, String pass, String h, String p) throws Exception {

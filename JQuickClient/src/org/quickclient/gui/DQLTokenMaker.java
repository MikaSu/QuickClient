...
/**
 * TokenMaker for DQL. Contains mainly copied code and have no idea how this stuff works.
 * Keywords have been replaced :)
 */
public class DQLTokenMaker extends AbstractTokenMaker {
	...
	public TokenMap getWordsToHighlight() {
		...
		tokenMap.put("from",				reservedWord);
		tokenMap.put("where",				reservedWord);
		tokenMap.put("enable",				reservedWord);
		tokenMap.put("order by",				reservedWord);
		tokenMap.put("public",				reservedWord);
		tokenMap.put("private",				reservedWord);
		tokenMap.put("with",				reservedWord);
		tokenMap.put("members",				reservedWord);
		
		int function = Token.FUNCTION;
		tokenMap.put("abort",			function);
		tokenMap.put("alter group",			function);
		tokenMap.put("alter aspect",			function);
		tokenMap.put("alter type",			function);
		tokenMap.put("begin tran",			function);
		tokenMap.put("change",			function);
		tokenMap.put("commit",			function);
		tokenMap.put("create",			function);
		tokenMap.put("delete",			function);
		tokenMap.put("drop group",			function);
		tokenMap.put("drop type",			function);
		tokenMap.put("execute",			function);
		tokenMap.put("grant",			function);
		tokenMap.put("insert",			function);
		tokenMap.put("register",			function);
		tokenMap.put("revoke",			function);
		tokenMap.put("select",			function);
		tokenMap.put("unregister",			function);
		tokenMap.put("update",			function);

		int attrname = Token.VARIABLE;
		tokenMap.put("object_name", attrname);
		

		int operator = Token.OPERATOR;
		tokenMap.put("and", operator);
		tokenMap.put("not", operator);
		tokenMap.put("or", operator);
		
		int datatype = Token.DATA_TYPE;
		tokenMap.put("char", datatype);
		
		int adminmethod = Token.ERROR_CHAR;
		tokenMap.put("show_sessions", adminmethod);
		int aa = Token.ANNOTATION;
		tokenMap.put("return_top", aa);
		return tokenMap;
	}

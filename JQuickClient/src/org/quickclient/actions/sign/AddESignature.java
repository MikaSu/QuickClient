...
public class AddESignature implements IQuickAction {
	...
	public void execute() throws QCActionException {
		...
		try {
			...
			for (int i = 0; i < idlist.size(); i++) {
				...
				String passowrd = (String) JOptionPane.showInputDialog("Enter Password");
				String Justification = (String) JOptionPane.showInputDialog("Enter Justification");
				obj.addESignature(username, passowrd, Justification, "", "", "", "", "", "", "");
			}
